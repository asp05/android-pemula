...
import com.sugara.androidfundamentalsubmissionawal.databinding.ItemHorizontalEventBinding


class EventHorizontalAdapter : ListAdapter<ListEventsItem, EventHorizontalAdapter.MyViewHolder>(DIFF_CALLBACK) {
